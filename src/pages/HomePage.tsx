        ...
        <section className="hero-section">
          <div className="hero-content fade-in">
            ...
            <div className="social-links">
              ...
              <a
                href="https://bkz.ro/lansare-fericirea-e-in-actul-urmator"
                target="_blank"
                rel="noopener noreferrer"
                className="social-link"
                aria-label="BookZone"
        ...
        <section className="about-section section-padding">
          <div className="container">
            <div className="about-content">
              <div className="section-title">Despre mine</div>
              <div className="about-text">
                <p>
                  ...
                  despre oameni și despre mine. Din 2002 sunt la Teatrul
                  Național din București, un loc care m-a crescut, m-a obosit,
                  m-a provocat și m-a ținut viu.
                </p>
                <p>
                  ...
                  destule), să încerc lucruri noi, să mă arunc cu totul și să
                  văd ce iese. Poate de asta am început si coregrafia, poate de
                  asta la 40 de ani mi-am propus primul maraton.
                </p>
                <p>
                  Nu mi-e frică să greșesc. Chiar dimpotrivă, mă bucur când o
                  fac, pentru că atunci învăț cel mai mult. Teatrul pentru mine
                  nu este despre aplauze, ci despre adevăr. Despre momentele
                  alea mici în care tăcerea din sală spune tot. Despre emoția
                  aia care trece dintr-un om în altul fără cuvinte.
                </p>
                <p>
                  Iubesc ce fac. Și oricât de greu ar fi uneori, ma simt norocos
                  că pot trăi din asta și prin asta. Vă aștept la teatru cu tot
                  ce sunt.
                </p>
                <p>Cu drag,</p>
                <p>Marius</p>
        ...
        <section className="cta-section">
          <div className="container">
            <div className="cta-content">
              ...
              <p>
                Vă invit cu drag la spectacole și mă bucur pentru fiecare mesaj
                pe care îl primesc, răspund cu plăcere.
              </p>
              <p>
              ...
              <div className="cta-buttons">
                <Link to="/spectacole" className="btn-primary">
